...
function renderSkillsTemplate(skills, svg) {  
  ...
  desc.textContent = "A radar chart showing skill proficiency levels across different categories";
  svg.appendChild(desc);
  
  // Set ARIA attributes
  svg.setAttribute("role", "img");
  svg.setAttribute("aria-labelledby", "skills-chart-title skills-chart-desc");
